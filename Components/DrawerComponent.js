...
const DrawerComponent = ({ userDetails }) => {
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen component={ProductsForm} name="ProductsForm" initialParams={userDetails} />
      <Drawer.Screen
      ...
      <Drawer.Screen component={CategoryForm} name="CategoryForm" initialParams={userDetails} />
